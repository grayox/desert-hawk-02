...
#### update procedure - v02
 ...
 4. src/firebaseService/firebaseServiceConfig.js
    save as... -orig
    paste firebase config credentials
 5. install firebase `yarn add react-redux-firebase redux-firestore`
 6. src/firebaseService/react-redux-firebase
    create this directory by cloning the code here: https://github.com/prescottprue/react-redux-firebase
 7. src/firebaseService/redux-firestore
    create this directory by cloning the code here: https://github.com/prescottprue/redux-firestore
 8. Abandon idea behind 6. and 7. Move files to src/database/lib
 9. .src/store.js
    save as... -orig
    modify with code from marioplan/src/index.js
10. src/my-app/config/fbConfig
    paste file copied from marioplan/src/config/fbConfig.js
...
12. find: `import firebaseService from '`
    replace with: `// import firebaseService from '`
13. comment out `firebaseService.`
      - src/auth/store/actions/user.actions.js
      - src/auth/Auth.js (x2)
      - src/auth/store/actions/login.actions.js (x2) - `add console.log()`
      - src/auth/store/actions/register.actions.js - `add console.log()`
14. roll back items 9 through 13 because causes problem reading `fuse.themes` from src/@fuse/components/FuseTheme/FuseTheme.js
      - store.js => rename to => store1.js
      - store-orig.js => rename to => store.js
15. src/auth/Auth.js
    save as... -orig
    comment out `auth0`
16. src/firebaseService/firebaseService.js
    save as... -orig
...
21. src/store.js
    ...
    insert from react-redux-firebase // http://react-redux-firebase.com/docs/v2-migration-guide.html
22. Error:
    > Unhandled Rejection (Error): The Firebase auth state could not be found in the store under the attribute 'firebase.auth'. Make sure your react-redux-firebase reducer is correctly set in the store
23. src/index.js
    save as... -orig
    modify with code from marioplan/src/index.js
